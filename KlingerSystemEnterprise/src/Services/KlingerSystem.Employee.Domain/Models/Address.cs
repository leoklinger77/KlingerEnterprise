...
namespace KlingerSystem.Employee.Domain.Models
{
    public class Address : Entity
    {
        ...
        public Address(Guid employeeId, string zipCode, string street, string number, string neighborhood, string city, string state, string complement = null, string reference = null)
        {
