...
namespace KlingerSystem.Authentication.Api.Configuration
{
    public static class SwaggerConfiguration
    {
        public static IServiceCollection SwaggerConfig(this IServiceCollection services)
        {
            ...
            {
                s.OperationFilter<SwggerDefaultValues>();
        ...
        public static IApplicationBuilder SwaggerApp(this IApplicationBuilder app, IApiVersionDescriptionProvider provider)
        {
            app.UseSwagger();
            app.UseSwaggerUI(c =>
            {
    ...
    public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
        {
            ...
            {
                Title = "KlingerSystem Authentication API",
